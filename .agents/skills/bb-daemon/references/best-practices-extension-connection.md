...
The daemon accepts one WebSocket connection from the browser extension and forwards bookmark operations over it.
...
3. Bookmark endpoints delegate to the extension over a JSON-RPC channel.
